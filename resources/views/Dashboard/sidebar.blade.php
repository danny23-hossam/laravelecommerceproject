        ...
        <ul class="metismenu" id="sidenav">
          <li>
            ...
            <ul>
              <li><a href="{{ route("category.create") }}"><i class="material-icons-outlined">arrow_right</i>Create Category</a>
               ...
               <li><a href="{{ route("category.show") }}"><i class="material-icons-outlined">arrow_right</i>Show Categories</a>
              </li>
          ...
          <li>
            ...
            <ul>
              ...
              <li><a href="{{ route("product.show") }}"><i class="material-icons-outlined">arrow_right</i>Show Product</a>
              </li>
            </ul>
          </li>
